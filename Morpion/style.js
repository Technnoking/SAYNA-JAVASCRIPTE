...
function myFunction(clicked_id) {
  if (clicked % 2 == 0) {
    $('#' + clicked_id).html(
      `<p class = "animated bounceIn" style="font-size:2em;color:#4286f4;">` +
        player.team +
        `</p>`
    );
...
function computer() {
  ...
  var res = grid[ran];
  $('#' + res).html(
    `<p class = "animated bounceIn" style="font-size:2em;color:#e29126;">` +
      cpu.team +
      `</p>`
  );
...
function winning(valeur) {
  if (clicked % 2 == 0) {
    $('#' + valeur[0] + ', #' + valeur[1] + ', #' + valeur[2]).html(
      `<p class = "animated bounceIn" style="font-size:2em;color:#3fcc64;">` +
        player.team +
        `</p>`
    );
    playerScore++;
